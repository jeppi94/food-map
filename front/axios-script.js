...
var options = {
  //지도를 생성할 때 필요한 기본 옵션
  center: new kakao.maps.LatLng(37.61, 126.92), //지도의 중심좌표. 서울 한가운데
...
async function getDataSet(category) {
  ...
  const dataSet = await axios({
    method: "get",
    url: `http://3.34.15.83:3000/restaurants?category=${qs}`,
    headers: {},
    data: {},
  });
...
function getContent(data) {
  ...
  <div class="infowindow">
      ...
      <div class="infowindow-body">
        ...
        <a href="${data.mapUrl}" class="infowindow-btn" target="_blank">정보이동</a>
      </div>
    </div>
  `;
}
